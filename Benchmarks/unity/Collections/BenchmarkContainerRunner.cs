        ...
        public static void Run(int capacity, BenchmarkContainerType type) {
            ...
            switch (type) {
                case BenchmarkContainerType.BCL:
                    BenchmarkMeasure.Measure(typeof(T), 10, () => container.MeasureBCL(), () => container.AllocBCL(capacity));
                    break;

                case BenchmarkContainerType.Morpeh:
                    BenchmarkMeasure.Measure(typeof(T), 10, () => container.MeasureMorpeh(), () => container.AllocMorpeh(capacity));
                    break;
            }
        }
    }
